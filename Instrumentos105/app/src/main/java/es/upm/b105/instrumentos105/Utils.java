...
public class Utils {
    ...
    public static final int CLAVE_PUBLICA = 23;
    public static final int MODULO = 2279;

    private boolean logged = false;
    private boolean borrado = false;
    private boolean permisos = false;

    private String direccion = "http://10.7.2.60:2000/instrumentos_acceso105";
    ...
    /**
     * Construye el APDU que selecciona la aplicacion
     * @param aid identificacion de la aplicación
     * @return
     */
    public static byte[] BuildSelectApdu(String aid) {
        // Format: [CLASS | INSTRUCTION | PARAMETER 1 | PARAMETER 2 | LENGTH | DATA]
        Log.i("SELECT APDU DEL MOVIL", SELECT_APDU_HEADER + String.format("%02X",
                aid.length() / 2) + aid);
    ...
    /**
     * Convierte una secuencia de bytes en un String de valores hexadecimales
    ...
    /**
     * Convierte un String de valores hexadecimales en una secuencia de bytes
    ...
    /**
     * Concatena dos secuencias de bytes
     * @param first primera parte a concatenar
     * @param rest segunda parte a concatenar
     * @return
     */
