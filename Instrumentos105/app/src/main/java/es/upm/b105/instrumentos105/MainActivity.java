...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pref = SharedPreferenceUtils.getInstance(MainActivity.this);
    ...
    protected void onDestroy() {
        super.onDestroy();
        SharedPreferences PreferenciasCompartidas = getSharedPreferences("UserPrefs",0);
