	...
	<?php
		...
		if($entrada = $enlace->query("SELECT permisos FROM " . $dbusuarios . " WHERE permisos='1'")){
			...
			if($entrada->num_rows === 0){
				...
				<input type='hidden' name='hasta' value='23:59:59' />
				...
				<input type='password' name='repet' /></p>
				<p><label>Introduce la hora de acceso:</label><br />
				<input type='time' name='desde' /></p>
				<p><label>Introduce la hora de salida:</label><br />
				<input type='time' name='hasta' /></p>
